...
export const experience = [
  {
    id: "0",
    icon: "/images/feature-1.png",
    caption: "July 2023 - May 2024",
    title: "Quality Assurance",
    text: `Led a team of 3 in manual and automated testing.
Developed and implemented an automated QA program for a 6-month project.
Identified and documented software defects for resolution.
Conducted meetings to review client requests and development priorities.
Promoted to permanent employee within 6 months.`,
    button: {
      icon: "/images/magictouch.svg",
  ...
  },
  {
    id: "1",
    icon: "/images/feature-2.png",
    caption: "April 2024 - Now",
    title: "Front End Developer",
    text: `Partnered with back-end developers to resolve API issues.
Resolved 30+ client issues/requests monthly through a ticketing system.
Translated user feedback into actionable development tasks.
...
export const faq = [
  {
    id: "0",
    question: "What is your educational background?", // Lebih formal dan umum digunakan
    answer:
      "I hold a Diploma in Agricultural Mechanization Technology and have furthered my skills as a full-stack JavaScript developer through an intensive bootcamp. While working, I also pursued a Bachelor's degree in Agricultural Mechanization Technology.", // Kalimat lebih singkat, jelas, dan menggunakan bahasa Inggris yang lebih baik
  },
  {
    id: "1",
    question: "Why are you passionate about IT?",
    answer:
      "My curiosity about IT has grown significantly over time. The challenges I faced during my bootcamp have instilled in me a strong work ethic, focus, and a never-give-up attitude. These experiences have solidified my passion for this field.", // Kalimat lebih flow, menekankan pertumbuhan minat dan pengembangan diri
  },
];
